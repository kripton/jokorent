...
CREATE TABLE IF NOT EXISTS "accounting" (
  ...
  "reference" INTEGER,                         -- FOREIGN KEY. Can refer to bills.id (type = bills), refunds.id (type = refund), inventory_items.id (type = inventory). OR NULL when not related to a job
  PRIMARY KEY("id")
);
